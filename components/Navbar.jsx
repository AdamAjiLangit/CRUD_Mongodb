...
export default function Navbar() {
    return (
        <nav className="flex justify-between items-center bg-blue-500 px-8 py-3 rounded">
            ...
            <Link className="bg-white font-bold text-blue-500 p-2 rounded-md hover:text-white hover:bg-blue-500 hover:border transition duration-300" href={"/addTopic"}>Add Topic</Link>
        </nav>
    );
}